...
// Correct answers
String[] correctAnswers = { "int function();", "new", "try", "value_2", "class MyClass {};", "2", "MyClass obj;", "->",
		"It refers to current object", "1", "~MyClass();", "iostream", "Takes input", "const", "//", "int *ptr;",
		"public", "float", "C++", "virtual" };
...
try {
	...
	PreparedStatement ps = conn.prepareStatement("UPDATE score SET cpp_score = ? WHERE username = ?");
	ps.setInt(1, score);
