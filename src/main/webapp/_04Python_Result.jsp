...
// Correct answers
String[] correctAnswers = {"class_list","def","list","#","8","indentation","remove",".py","set","try","13","False","//","HelloHelloHello","append()","Does nothing","Class","def myFunc():","True","try-except"};
...
try {
	...
	PreparedStatement ps = conn.prepareStatement("UPDATE score SET python_score = ? WHERE username = ?");
	ps.setInt(1, score);
...
<body>
	<div class="header">Python Programming Quiz Result</div>
	<div class="content">
		<div class="score">
			Your Score:
			<%=score%>
